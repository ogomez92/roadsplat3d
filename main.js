...
class Coin extends _item.Item {
  ...
  step() {
    _main.data.coins += this.world.game.level;
...
exports.Car = Car;
},{"./gameObject":"gameObject.js","./stationaryObject":"stationaryObject.js","./utilities":"utilities.js","./tts":"tts.js","./main":"main.js"}],"levelPortal.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.LevelPortal = void 0;
...
class LevelPortal extends _gameObject.GameObject {
      ...
      if (!this.world.player.jump) {
        if (!this.passed) {
          ...
          if (!this.passed && this.alive && Math.round(this.x) == this.world.player.x && this.world.player.tileType == 1) {
            this.passed = true;
            this.tile.hasSomething = false; //level here
...
exports.LevelPortal = LevelPortal;
},{"./gameObject":"gameObject.js","./strings":"strings.js","./stationaryObject":"stationaryObject.js","./utilities":"utilities.js","./tts":"tts.js","./main":"main.js"}],"road.js":[function(require,module,exports) {
"use strict";
...
var _levelPortal = require("./levelPortal");
...
class Road extends _tile.Tile {
  ...
  generateCar(force) {
    ...
    try {
      let chance = _utilities.utils.randomInt(1, 100); //carType=content.numberOfVehicles
...
exports.Road = Road;
},{"./gameObject":"gameObject.js","./car":"car.js","./levelPortal":"levelPortal.js","./main":"main.js","./utilities":"utilities.js","./tile":"tile.js","./tts":"tts.js"}],"effect.js":[function(require,module,exports) {
"use strict";
...
class Player extends _gameObject.GameObject {
  constructor(world) {
    ...
    this.speeds = [0, 650, 530, 420, 350, 235, 675, 120];
  ...
  flyTo(y, side, snd, landsound = "player/land") {
    ...
    let land = _soundObject.so.create(landsound);
  ...
  throwBomb() {
    try {
      ...
      setTimeout(() => {
        sound.destroy();
        new _stationaryObject.StationaryObject(this.world, this.y + 0.5, "bomb_explode");
        this.emit("blowup");
      }, fusetime);
    } catch (e) {
      console.error(e);
...
class Game {
  ...
  update(dt) {
    if (this.input.isJustPressed(_keycodes.KeyEvent.DOM_VK_0)) {
      if (_main.data.stoppers >= 1) {
        this.world.game.pool.playStatic("use_stopper", false);
        _main.data.stoppers--;
        (0, _main.save)();
        this.world.player.slowDown(10);
      } else {
        _tts.speech.speak(_strings.strings.get("noStoppers"));
      }
    }

    if (this.input.isJustPressed(_keycodes.KeyEvent.DOM_VK_D) && _main.debug) {
      let debugRoad = new _road.Road(this.world, this.world.player.y + 1, true);
    ...
    if (this.input.isJustPressed(_keycodes.KeyEvent.DOM_VK_B)) {
      if (_main.data.bombs >= 1 || _main.debug) {
        this.world.player.throwBomb();
        if (!_main.debug) _main.data.bombs--;
        (0, _main.save)();
      } else {
        _tts.speech.speak(_strings.strings.get("noBombs"));
      }
    }
    ...
    if (this.input.isJustPressed(_keycodes.KeyEvent.DOM_VK_I)) {
      ...
      if (_main.data.stoppers > 0) {
        nothing = false;
        str += _strings.strings.get("iStoppers", [_main.data.stoppers]) + ", ";
      }
    ...
    if (this.input.isJustPressed(_keycodes.KeyEvent.DOM_VK_C)) {
      _tts.speech.speak(_main.data.coins + _strings.strings.get("coins"));
    }

    if (this.input.isJustPressed(_keycodes.KeyEvent.DOM_VK_S)) {
      _tts.speech.speak(this.score + _strings.strings.get("points" + ", " + _strings.strings.get("bankedScore") + this.world.game.bankedScore));
    }
...
async function setup() {
  ...
  let langs = new _languageSelector.LanguageSelector("langSelect", async result => {
    ...
    _tts.speech.setRate(3); //await strings.check(2)
